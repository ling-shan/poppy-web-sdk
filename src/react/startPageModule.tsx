...
import { WebModuleFactory, startWebModule } from "../utils/webModule";
...
export function startPageModule (opts: CreatePageFactoryOpts) {
  startWebModule(createPageFactory(opts));
}
